...
import mfbeltran.cardviewfirebase.Recycler.MyAdapter;

public class MainActivity extends AppCompatActivity {

    final static String DB_URL = "https://cardview.firebaseio.com/";
    ...
    private void getUpdates(DataSnapshot dataSnapshot) {
        ...
        {
            adapter=new MyAdapter(getApplicationContext(),informations);
